...
Breadcrumbs::register('admin.games.index', function (Generator $breadcrumbs) {
    $breadcrumbs->push(__('views.admin.dashboard.title'), route('admin.dashboard'));
    $breadcrumbs->push(__('views.admin.games.index.title'));
});
...
Breadcrumbs::register('admin.users.show', function (Generator $breadcrumbs, \OmgGame\Models\Auth\User\User $user) {
    $breadcrumbs->push(__('views.admin.dashboard.title'), route('admin.dashboard'));
...
Breadcrumbs::register('admin.users.edit', function (Generator $breadcrumbs, \OmgGame\Models\Auth\User\User $user) {
    $breadcrumbs->push(__('views.admin.dashboard.title'), route('admin.dashboard'));
    $breadcrumbs->push(__('views.admin.users.index.title'), route('admin.users'));
