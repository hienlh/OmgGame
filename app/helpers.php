...
if (!function_exists('protection_shop_token')) {
    ...
    /**
     * @param \OmgGame\Models\Auth\User\User $user
     * @param null $successUrl
     * @param null $cancelUrl
     * @param null $successUrlTitle
     * @param null $cancelUrlTitle
     * @return \OmgGame\Models\Protection\ProtectionShopToken
     */
    function protection_shop_token(\OmgGame\Models\Auth\User\User $user, $successUrl = null, $cancelUrl = null, $successUrlTitle = null, $cancelUrlTitle = null)
    {
...
if (!function_exists('protection_validate')) {
    ...
    /**
     * @param \OmgGame\Models\Auth\User\User $user
     * @return \OmgGame\Models\Protection\ProtectionValidation
     */
    function protection_validate(\OmgGame\Models\Auth\User\User $user)
    {
