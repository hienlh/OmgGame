    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Create User <a href="{{route('users.index')}}" class="btn btn-info btn-xs"><i
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" action="{{ route('users.store') }}" data-parsley-validate
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ Request::old('password') ?: '' }}" id="password"
                            ...
                            <div class="form-group{{ $errors->has('confirm_password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ Request::old('confirm_password') ?: '' }}"
