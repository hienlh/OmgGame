    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Edit Game <a href="{{route('gameUsers.index')}}" class="btn btn-info btn-xs"><i
                                    class="fa fa-chevron-left"></i> Back </a></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br/>
                        <form method="post" action="{{ route('gameUsers.update', ['id' => 1]) }}" data-parsley-validate
                            ...
                            <div class="form-group{{ $errors->has('brand') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="" id="brand" name="brand" readonly
