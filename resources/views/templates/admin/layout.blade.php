        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>Omg Game!</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Products <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('games.index')}}">Games list</a></li>
                                    <li><a href="{{route('gameUsers.index')}}">Users List</a></li>
                                    <li><a href="{{route('gameResults.index')}}">Results list</a></li>
                                </ul>
                            </li>
                            <li><a href="{{route('games.index')}}"><i class="fa fa-user"></i> Customers </a></li>
                            <li><a href="{{route('games.index')}}"><i class="fa fa-shopping-cart"></i> Orders </a></li>
                            <li><a href="{{route('games.index')}}"><i class="fa fa-users"></i> Users </a></li>
                        </ul>
                    </div>
                </div>
                <!-- /sidebar menu -->
