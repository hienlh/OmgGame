<?php $__env->startSection('title',__('views.admin.gameResults.edit.title') ); ?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">
                    <?php echo e(__('views.admin.gameResults.edit.description')); ?>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="name" type="text"
                           ...
                           name="description" value="<?php echo e($result->description); ?>" required>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">
                    <?php echo e(__('views.admin.gameResults.edit.image')); ?>

                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="name" type="text"
                           class="form-control col-md-7 col-xs-12 <?php if($errors->has('image')): ?> parsley-error <?php endif; ?>"
                           name="image" value="<?php echo e($result->image); ?>" readonly>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">
                    <?php echo e(__('views.admin.gameResults.edit.design')); ?>

                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="design" type="text"
                           class="form-control col-md-7 col-xs-12 <?php if($errors->has('design')): ?> parsley-error <?php endif; ?>"
                           name="design" value="<?php echo e($result->design); ?>" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <a class="btn btn-primary"
                       href="<?php echo e(URL::previous()); ?>"> <?php echo e(__('views.admin.gameResults.edit.cancel')); ?></a>
                    <button type="submit"
                            class="btn btn-success"> <?php echo e(__('views.admin.gameResults.edit.save')); ?></button>
                </div>
            </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><?php echo e(__('views.admin.gameResults.edit.design_tab_title')); ?></h2>
                    ...
                    function loadJson(json) {
                        if (json) {
                            ...
                            if (imageBackground) {
                                ...
                                bgImgObj.src = '<?php echo e(asset($result->image)); ?>';
                            }
                        } else {
                        ...
                        avaImgObj.src = '<?php echo e(asset('assets/admin/images/default-avatar.png')); ?>';
                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Laravel\laravel-boilerplate\resources\views/admin/gameResults/edit.blade.php ENDPATH**/ ?>