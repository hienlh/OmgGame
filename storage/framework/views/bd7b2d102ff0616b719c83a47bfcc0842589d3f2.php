<?php $__env->startSection('title',__('views.admin.gameResults.create.title') ); ?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">
                    <?php echo e(__('views.admin.gameResults.create.description')); ?>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a class="btn btn-primary"
                       href="<?php echo e(URL::previous()); ?>"> <?php echo e(__('views.admin.gameResults.create.cancel')); ?></a>
                    <button type="submit"
                            class="btn btn-success"> <?php echo e(__('views.admin.gameResults.create.submit')); ?></button>
                </div>
            </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><?php echo e(__('views.admin.gameResults.create.design_tab_title')); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Laravel\laravel-boilerplate\resources\views/admin/gameResults/create.blade.php ENDPATH**/ ?>