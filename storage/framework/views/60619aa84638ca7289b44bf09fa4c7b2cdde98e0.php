                ...
                <ul class="nav side-menu">
                    <li>
                        <a href="<?php echo e(route('admin.games.index')); ?>">
                            ...
                            <?php echo e(__('views.backend.section.navigation.games')); ?>
...
<?php /**PATH E:\Project\Laravel\laravel-boilerplate\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>